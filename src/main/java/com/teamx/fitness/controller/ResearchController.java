...
/**
 * 🔬 Research Controller - Endpoints for research data aggregation and
 * analysis.
 * 
 * This controller provides endpoints for research users to access aggregated,
 * anonymized data for research purposes. NO PII (Personal Identifiable
 * Information)
...
@CrossOrigin(origins = "*")
@Tag(name = "Research Controller", description = "🔬 Endpoints for research data aggregation and analysis. "
...
public class ResearchController {
   ...
   *
   * @throws ResponseStatusException with 403 Forbidden if the client is not
   *                                 authorized
   */
   ...
   * 
   * @return ResponseEntity containing anonymized data summary
   */
  @GetMapping("/persons")
  @Operation(summary = "Retrieve all users' anonymized data", 
   ...
   * 
   * @param ageRange Age range filter (e.g., '25-34', '35-44')
   * @param gender Gender filter (optional)
   * @param objective Fitness objective filter (optional)
   * @return ResponseEntity containing demographic statistics
   */
  @GetMapping("/demographics")
  @Operation(summary = "Get aggregated statistics by demographic cohort", 
   ...
   * 
   * @param ageRange Age range filter (optional)
   * @return ResponseEntity containing workout pattern analysis
   */
  @GetMapping("/workout-patterns")
  @Operation(summary = "Get workout pattern analysis by demographic", 
  ...
  public ResponseEntity<Map<String, Object>> getWorkoutPatterns(
      @Parameter(description = "Age range filter (optional)") @RequestParam(required = false) String ageRange) {
   ...
   * 
   * @param objective Fitness objective filter (BULK, CUT, RECOVER)
   * @return ResponseEntity containing nutrition trends
   */
  @GetMapping("/nutrition-trends")
  @Operation(summary = "Get nutrition trends by fitness objective", 
   ...
   * 
   * @return ResponseEntity containing population health metrics
   */
  @GetMapping("/population-health")
  @Operation(summary = "Get population health metrics", 
